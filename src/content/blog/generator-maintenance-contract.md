---
title: "Generator Maintenance Contracts in Nigeria: What a Proper O&M Agreement Must Contain"
navTitle: "Generator Maintenance"
metaTitle: "Generator Maintenance Contract Nigeria: O&M Checklist"
metaDescription: "What a generator maintenance contract in Nigeria must contain: scope by running hours, response times, spares lead times, load bank testing and penalty clauses."
primaryKeyword: "generator maintenance contract nigeria"
secondaryKeywords: "generator O&M agreement Nigeria, diesel generator servicing contract, generator maintenance contract cost, annual maintenance contract generator Lagos, power plant O&M contract Nigeria"
...
faq:
  ...
  - question: "Should the contract be based on calendar visits or running hours?"
    answer: "Running hours, with a calendar backstop for sets that run very little. Engine wear tracks hours and load factor, so a quarterly visit schedule under-services a hard-worked set and over-services a rarely used standby machine. A backstop of one visit every six months protects lightly used sets against battery, coolant and fuel degradation, which are time-driven rather than hours-driven."
  - question: "What should the response time clause say?"
  ...
  - question: "Does a maintenance contract cover a major overhaul?"
    answer: "Usually not, and you should assume it does not unless the document says otherwise in a numbered clause. Overhauls at 12,000 to 20,000 hours require an outage window, workshop facilities, specialist measurement and qualified engineers on site, and they are priced as separate projects. A good agreement instead commits the contractor to forecast the overhaul from oil analysis and performance trending so it can be budgeted and planned rather than triggered by a failure."
---
...
If you are re-tendering an existing arrangement, [request a technical proposal](/#contact) with the asset schedule attached so that quotes are comparable line by line rather than lump sum against lump sum.
...
Ask for the contractor's parts sourcing route in writing. OEM channel, authorised distributor or open market are three different risk profiles for price, warranty and counterfeit exposure. The same logic applies further up the plant, and the reasoning is set out in more detail in our note on [turbine spare parts lead time](/blog/turbine-spare-parts-lead-time/).
...
Two regulatory points are worth confirming for your own installation. Self-generation above 1 MW requires a captive generation permit from the [Nigerian Electricity Regulatory Commission](https://nerc.gov.ng/), and installations are subject to inspection and certification regimes administered by the [Nigerian Electricity Management Services Agency](https://www.nemsa.gov.ng/). Neither obligation transfers to a maintenance contractor by default, so state in the agreement who prepares and holds the documentation.

Where a site has poor records, undocumented modifications or a history of repeat failures, the sensible first step is a plant assessment rather than a contract. A structured [power plant audit](/power-plant-audit-nigeria/) establishes actual condition, load profile and remaining life, which is also what makes competing bids comparable.
