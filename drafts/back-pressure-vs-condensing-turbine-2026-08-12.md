---
meta_title: "Back Pressure vs Condensing Steam Turbine: How to Choose"
meta_description: "How back pressure and condensing steam turbines differ on power per tonne of steam, cooling water and capex, with indicative Naira costs for Nigerian plants."
primary_keyword: "back pressure vs condensing steam turbine"
secondary_keywords: "back pressure steam turbine, condensing steam turbine, extraction condensing turbine, cogeneration steam turbine Nigeria, steam turbine selection"
---

# Back Pressure vs Condensing Steam Turbine: Which Suits Your Process Plant
...
If you are sizing a steam turbine against an existing boiler and process load and want the arithmetic done on your actual figures, [request a technical proposal](/#contact) and we will start from your steam balance rather than a nameplate.
...
| Item | Back pressure | Extraction-condensing | Full condensing |
| --- | --- | --- | --- |
| Exhaust pressure | 2 to 15 bar a, into process header | 0.08 to 0.15 bar a, plus controlled extraction | 0.08 to 0.15 bar a |
| Power per tonne/hour of steam | 50 to 90 kW | 90 to 200 kW, depends on extraction split | 200 to 240 kW |
...
Condensing plant also brings wet steam into the last stages. Moisture erosion on long last stage blades is a known life-limiting mechanism, and it is one of the conditions that shows up first as a change in vibration signature. If your existing machine is already telling you something, our note on [steam turbine high vibration](/blog/steam-turbine-high-vibration/) covers what the readings usually mean before you open a casing.
...
Fix the performance test basis in the contract. Steam turbine acceptance testing sits under ASME PTC 6 and condenser performance under ASME PTC 12.2, and referencing the code is more defensible than paraphrasing an efficiency figure into a purchase order. The catalogue is published at [asme.org](https://www.asme.org/codes-standards).

Check your permitting position at the same time. Captive generation above the statutory threshold requires a permit, and adding or replacing generating plant changes what you previously declared. The current requirements are published by the [Nigerian Electricity Regulatory Commission](https://nerc.gov.ng/), and lead time there belongs in your project schedule rather than at the end of it.
...
Steam turbine selection, commissioning and subsequent life all sit under [steam turbine overhaul and services](/steam-turbine-overhaul-nigeria/), and where the question spans the whole generation and process heat arrangement, a [power plant audit](/power-plant-audit-nigeria/) is the right starting point. To have your steam and electrical load data reviewed against both configurations, request a technical proposal.
